...
import com.lizhi.lidada.common.*;
...
import com.lizhi.lidada.model.dto.app.AppAddRequest;
import com.lizhi.lidada.model.dto.app.AppEditRequest;
import com.lizhi.lidada.model.dto.app.AppQueryRequest;
import com.lizhi.lidada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        app.setReviewStatus(ReviewStatusEnum.REVIEWING.getValue());//默认填充待审核
        // 写入数据库
    ...
    public BaseResponse<Boolean> doAppReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        ...
        if (oldApp.getReviewStatus().equals(reviewStatus)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "该状态已存在，请勿重复审核");
...
//更新审核状态
        ...
        boolean result = appService.updateById(app); //mybatis-plus函数
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
        return ResultUtils.success(true);
