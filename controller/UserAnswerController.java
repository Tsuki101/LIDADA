...
import com.lizhi.lidada.model.dto.userAnswer.UserAnswerAddRequest;
import com.lizhi.lidada.model.dto.userAnswer.UserAnswerEditRequest;
import com.lizhi.lidada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.lizhi.lidada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.lizhi.lidada.model.enums.ReviewStatusEnum;
import com.lizhi.lidada.model.vo.UserAnswerVO;
import com.lizhi.lidada.scoring.ScoringStrategyExecutor;
import com.lizhi.lidada.service.AppService;
import com.lizhi.lidada.service.UserAnswerService;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if(!ReviewStatusEnum.PASS.equals(ReviewStatusEnum.getEnumByValue(app.getReviewStatus()))){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR,"该应用未通过审核,无法提交答案");
        }
        // 填充默认值
